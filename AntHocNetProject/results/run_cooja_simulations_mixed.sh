...
# Usage: ./run_cooja_simulations.sh <csc_file_name> <num_runs> (to be executed in AntHocNetProject/results)
# Example: ./run_cooja_simulations.sh my_simulation.csc 5
...
DELETE_POSITIONS_SCRIPT="delete_positions.py"
...
for (( i=1; i<=NUM_RUNS; i++ )); do
    ...
    python3 $DELETE_POSITIONS_SCRIPT $RUNS_DIR/positions.dat
